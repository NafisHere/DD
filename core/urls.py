...
def legacy_page_redirect(request, page_name):
    redirect_map = {
        "index.html": "core:index",
        "page-account.html": "userauths:sign-in",
        "shop-wishlist.html": "core:wishlist",
        "shop-compare.html": "core:product-list",
        "shop-cart.html": "core:cart",
        "shop-order.html": "core:index",
        "page-register.html": "userauths:sign-up",
        "page-about.html": "core:index",
        "page-privacy-policy.html": "core:index",
    }
...
urlpatterns = [
    ...
    re_path(r'^(?P<page_name>[\w\-/]+\.html)$', legacy_page_redirect, name="legacy-page-redirect"), 
